...
class ApiService {
  ...
  Future<response.api.main.com.curiodesk.scraperbackend.response.api.main.java.com.curiodesk.scraperbackend.HybridLinkedInProfileResponse> scrapeProfile(String profileUrl) async {
    ...
    return response.api.main.com.curiodesk.scraperbackend.response.api.main.java.com.curiodesk.scraperbackend.HybridLinkedInProfileResponse.fromJson(body);
  }
}
